...
import 'package:loja_cs/app/pdf/pdf_view.dart';
import 'package:loja_cs/app/providers/itens_pedido_list.dart';
import 'package:loja_cs/app/widgets/cardResumo.dart';
import 'package:loja_cs/app/widgets/colors.dart';
import 'package:loja_cs/database/database.dart';
                                        ...
                                        child: Container(
                                          ...
                                          child: GestureDetector(
                                            ...
                                            onTap: () async {
                                              ...
                                              try {
                                                await launch(
                                                    'https://api.whatsapp.com/send?phone=5538988470267');
                                              } catch (error) {
                                                print(error);
                                              }
                                            },
